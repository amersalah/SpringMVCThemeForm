...
import com.boraji.tutorial.spring.entity.Entity;
...
public class MyController {
    ...
    @RequestMapping( value = "/persist.htm" ,method = RequestMethod.POST, consumes = "multipart/form-data")
    public String insertUser(@Valid @ModelAttribute("entity") Entity entity,
            @FormParam("attachment") MultipartFile attachment,
            @FormParam("customFile") MultipartFile customFile,
